...
func (h *FilepathHost) Match(pattern, name string) (bool, error) { return filepath.Match(pattern, name) }
func (h *FilepathHost) Rel(basepath, targpath string) (string, error) { return filepath.Rel(basepath, targpath) }
