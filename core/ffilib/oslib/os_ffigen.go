...
var OS_FFI_Metadata = []struct {
	...
	{"Open", 1, "function(String) tuple(Ptr<gopkg.d7z.net/go-mini/core/ffilib/oslib.File>, Error)", ""},
	{"Create", 2, "function(String) tuple(Ptr<gopkg.d7z.net/go-mini/core/ffilib/oslib.File>, Error)", ""},
...
var FileMethods_FFI_Metadata = []struct {
	...
	{"Read", 1, "function(Ptr<gopkg.d7z.net/go-mini/core/ffilib/oslib.File>, TypeBytes) tuple(Int64, Error)", ""},
	{"Write", 2, "function(Ptr<gopkg.d7z.net/go-mini/core/ffilib/oslib.File>, TypeBytes) tuple(Int64, Error)", ""},
	{"Close", 3, "function(Ptr<gopkg.d7z.net/go-mini/core/ffilib/oslib.File>) Error", ""},
}
