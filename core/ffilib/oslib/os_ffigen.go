...
func RegisterOS(executor interface{ RegisterFFI(string, ffigo.FFIBridge, uint32, ast.GoMiniType, string) }, impl OS, registry *ffigo.HandleRegistry) {
...
func RegisterFileMethods(executor interface{ RegisterFFI(string, ffigo.FFIBridge, uint32, ast.GoMiniType, string) }, impl FileMethods, registry *ffigo.HandleRegistry) {
