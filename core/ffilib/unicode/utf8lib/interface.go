//go:generate go run gopkg.d7z.net/go-mini/cmd/ffigen -pkg utf8lib -path gopkg.d7z.net/go-mini/core/ffilib/unicode/utf8lib -out utf8_ffigen.go interface.go
package utf8lib
