//go:generate go run gopkg.d7z.net/go-mini/cmd/ffigen -pkg fmtlib -module fmt -path gopkg.d7z.net/go-mini/core/ffilib/fmtlib -out fmt_ffigen.go interface.go
package fmtlib
