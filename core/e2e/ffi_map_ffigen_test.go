...
func RegisterE2EMapTestLibrary(executor interface{ RegisterFFI(string, ffigo.FFIBridge, uint32, ast.GoMiniType, string) }, prefix string, impl MapTest, registry *ffigo.HandleRegistry) {
