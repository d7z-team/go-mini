//go:generate go run ../../../cmd/ffigen/main.go -pkg canonicaltest -path gopkg.d7z.net/go-mini/core/e2e/canonicaltest -out canonical_type_ffigen.go canonical_type_infra.go
