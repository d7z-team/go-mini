...
func RegisterE2EMockGeometryLibrary(executor interface{ RegisterFFI(string, ffigo.FFIBridge, uint32, ast.GoMiniType, string) }, prefix string, impl MockGeometry, registry *ffigo.HandleRegistry) {
