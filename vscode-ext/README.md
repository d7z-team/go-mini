...
留空时从 VS Code 进程的 `PATH` 查找 `mini-go`；扩展不捆绑编译器二进制。命令安装方式见[项目 README](https://github.com/d7z-team/mini-go/blob/main/README.md#安装)。
...
项目与编辑器的使用约定见[使用指南](https://github.com/d7z-team/mini-go/blob/main/USAGE.md#编辑器与调试符号)。
