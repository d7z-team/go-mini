//go:generate go run gopkg.d7z.net/go-mini/core/cmd/ffigen -pkg timelib -out time_ffigen.go interface.go host.go
package timelib
...
// ffigen:module time
//
//nolint:revive // Mini mirrors Go standard library constant names for the exported FFI module.
const (
