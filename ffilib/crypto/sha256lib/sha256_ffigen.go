...
func SurfaceSHA256(impl SHA256) *surface.Bundle {
	...
	schema.AddConst("crypto/sha256", "BlockSize", runtime.ConstInt64(int64(sha256.BlockSize)))
	schema.AddConst("crypto/sha256", "Size", runtime.ConstInt64(int64(sha256.Size)))
