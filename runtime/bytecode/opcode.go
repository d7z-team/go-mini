...
const (
	...
	OpWaitableSubscribeRecv Opcode = "waitable_subscribe_recv"
	OpWaitableSubscribeSend Opcode = "waitable_subscribe_send"
	...
	OpMakeWaitToken   Opcode = "make_wait_token"
	OpWaitTokenSignal Opcode = "wait_token_signal"
	OpWaitTokenCancel Opcode = "wait_token_cancel"
	OpMakeWaitSet     Opcode = "make_wait_set"
	OpWaitSetAdd      Opcode = "wait_set_add"
	OpWaitSetPoll     Opcode = "wait_set_poll"
	OpWaitSetPark     Opcode = "wait_set_park"
	OpWaitSetCancel   Opcode = "wait_set_cancel"
